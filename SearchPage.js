...
class SearchPage extends Component {
	...
	_execteQuery(query) {
		...
		fetch(query)
			...
			.catch(error => this.setState({isLoading:false,message:'Something bad happende' + error}));
	}
...
function urlForQueryAndPage(key, value, pageNumber) {
	...
	var querystring = Object.keys(date).map(key => key + '=' + encodeURIComponent(date[key])).join('&');
